...
// WithRegisterUser adds the registerUser to the register user params
func (o *RegisterUserParams) WithRegisterUser(registerUser *models.RegisterUser) *RegisterUserParams {
	o.SetRegisterUser(registerUser)
	return o
}

// SetRegisterUser adds the registerUser to the register user params
func (o *RegisterUserParams) SetRegisterUser(registerUser *models.RegisterUser) {
	o.RegisterUser = registerUser
}
...
func (o *RegisterUserParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	var res []error
	if o.RegisterUser != nil {
		if err := r.SetBodyParam(o.RegisterUser); err != nil {
			return err
		}
	}
