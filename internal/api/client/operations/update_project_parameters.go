...
type UpdateProjectParams struct {
	...
	/* UpdateProjectBody.
	   ...
	   Update Project Body
	*/
	UpdateProjectBody *models.UpdateProjectBody
...
// WithUpdateProjectBody adds the updateProjectBody to the update project params
func (o *UpdateProjectParams) WithUpdateProjectBody(updateProjectBody *models.UpdateProjectBody) *UpdateProjectParams {
	o.SetUpdateProjectBody(updateProjectBody)
	return o
}

// SetUpdateProjectBody adds the updateProjectBody to the update project params
func (o *UpdateProjectParams) SetUpdateProjectBody(updateProjectBody *models.UpdateProjectBody) {
	o.UpdateProjectBody = updateProjectBody
}
...
func (o *UpdateProjectParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	var res []error
	if o.UpdateProjectBody != nil {
		if err := r.SetBodyParam(o.UpdateProjectBody); err != nil {
			return err
		}
	}
