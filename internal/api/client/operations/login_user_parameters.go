...
// WithLoginUser adds the loginUser to the login user params
func (o *LoginUserParams) WithLoginUser(loginUser *models.LoginUser) *LoginUserParams {
	o.SetLoginUser(loginUser)
	return o
}

// SetLoginUser adds the loginUser to the login user params
func (o *LoginUserParams) SetLoginUser(loginUser *models.LoginUser) {
...
func (o *LoginUserParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	var res []error
	if o.LoginUser != nil {
		if err := r.SetBodyParam(o.LoginUser); err != nil {
			return err
		}
	}
