...
// CreateChassisBody create chassis body
//
// swagger:model CreateChassisBody
type CreateChassisBody struct {
...
// Validate validates this create chassis body
func (m *CreateChassisBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CreateChassisBody) validateAxes(formats strfmt.Registry) error {
...
func (m *CreateChassisBody) validateHeight(formats strfmt.Registry) error {
...
func (m *CreateChassisBody) validateLength(formats strfmt.Registry) error {
...
func (m *CreateChassisBody) validateMaxNonOperatingTemperature(formats strfmt.Registry) error {
...
func (m *CreateChassisBody) validateMaxOperatingTemperature(formats strfmt.Registry) error {
...
func (m *CreateChassisBody) validateMaxVibrationRandom(formats strfmt.Registry) error {
...
func (m *CreateChassisBody) validateMaxVibrationSine(formats strfmt.Registry) error {
...
func (m *CreateChassisBody) validateMinNonOperatingTemperature(formats strfmt.Registry) error {
...
func (m *CreateChassisBody) validateMinOperatingTemperature(formats strfmt.Registry) error {
...
func (m *CreateChassisBody) validateMinVibrationRandom(formats strfmt.Registry) error {
...
func (m *CreateChassisBody) validateMinVibrationSine(formats strfmt.Registry) error {
...
func (m *CreateChassisBody) validateName(formats strfmt.Registry) error {
...
func (m *CreateChassisBody) validateOverload(formats strfmt.Registry) error {
...
func (m *CreateChassisBody) validatePeakFrequencySpectrum1(formats strfmt.Registry) error {
...
func (m *CreateChassisBody) validatePeakFrequencySpectrum2(formats strfmt.Registry) error {
...
func (m *CreateChassisBody) validatePeakOverloadSpectrum1(formats strfmt.Registry) error {
...
func (m *CreateChassisBody) validatePeakOverloadSpectrum2(formats strfmt.Registry) error {
...
func (m *CreateChassisBody) validatePowerHandlingCapabilityPerBoard(formats strfmt.Registry) error {
...
func (m *CreateChassisBody) validateShockResponseSpectrum(formats strfmt.Registry) error {
...
func (m *CreateChassisBody) validateSize(formats strfmt.Registry) error {
...
func (m *CreateChassisBody) validateSlots(formats strfmt.Registry) error {
...
func (m *CreateChassisBody) validateTemperaturePerBoard(formats strfmt.Registry) error {
...
func (m *CreateChassisBody) validateWeight(formats strfmt.Registry) error {
...
func (m *CreateChassisBody) validateWidth(formats strfmt.Registry) error {
...
// ContextValidate validates this create chassis body based on context it is used
func (m *CreateChassisBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *CreateChassisBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CreateChassisBody) UnmarshalBinary(b []byte) error {
	var res CreateChassisBody
