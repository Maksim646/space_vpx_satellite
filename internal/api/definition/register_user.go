...
func (m *RegisterUser) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateAgainPassword(formats); err != nil {
		res = append(res, err)
	}
...
func (m *RegisterUser) validateAgainPassword(formats strfmt.Registry) error {

	if err := validate.Required("again_password", "body", m.AgainPassword); err != nil {
		return err
	}
...
func (m *RegisterUser) validateName(formats strfmt.Registry) error {
