...
// SolarPanelSide solar panel side
//
// swagger:model SolarPanelSide
type SolarPanelSide struct {
...
// Validate validates this solar panel side
func (m *SolarPanelSide) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SolarPanelSide) validateID(formats strfmt.Registry) error {
...
// ContextValidate validates this solar panel side based on context it is used
func (m *SolarPanelSide) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *SolarPanelSide) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SolarPanelSide) UnmarshalBinary(b []byte) error {
	var res SolarPanelSide
