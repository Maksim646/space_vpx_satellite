...
// CreatePowerSystemBody create power system body
//
// swagger:model CreatePowerSystemBody
type CreatePowerSystemBody struct {
...
// Validate validates this create power system body
func (m *CreatePowerSystemBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CreatePowerSystemBody) validateHeight(formats strfmt.Registry) error {
...
func (m *CreatePowerSystemBody) validateLength(formats strfmt.Registry) error {
...
func (m *CreatePowerSystemBody) validateWidth(formats strfmt.Registry) error {
...
// ContextValidate validates this create power system body based on context it is used
func (m *CreatePowerSystemBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *CreatePowerSystemBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CreatePowerSystemBody) UnmarshalBinary(b []byte) error {
	var res CreatePowerSystemBody
