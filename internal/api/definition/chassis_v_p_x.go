...
// ChassisVPX chassis v p x
//
// swagger:model ChassisVPX
type ChassisVPX struct {
...
// Validate validates this chassis v p x
func (m *ChassisVPX) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ChassisVPX) validateAxes(formats strfmt.Registry) error {
...
func (m *ChassisVPX) validateHeight(formats strfmt.Registry) error {
...
func (m *ChassisVPX) validateLength(formats strfmt.Registry) error {
...
func (m *ChassisVPX) validateMaxNonOperatingTemperature(formats strfmt.Registry) error {
...
func (m *ChassisVPX) validateMaxOperatingTemperature(formats strfmt.Registry) error {
...
func (m *ChassisVPX) validateMaxVibrationRandom(formats strfmt.Registry) error {
...
func (m *ChassisVPX) validateMaxVibrationSine(formats strfmt.Registry) error {
...
func (m *ChassisVPX) validateMinNonOperatingTemperature(formats strfmt.Registry) error {
...
func (m *ChassisVPX) validateMinOperatingTemperature(formats strfmt.Registry) error {
...
func (m *ChassisVPX) validateMinVibrationRandom(formats strfmt.Registry) error {
...
func (m *ChassisVPX) validateMinVibrationSine(formats strfmt.Registry) error {
...
func (m *ChassisVPX) validateName(formats strfmt.Registry) error {
...
func (m *ChassisVPX) validateOverload(formats strfmt.Registry) error {
...
func (m *ChassisVPX) validatePeakFrequencySpectrum1(formats strfmt.Registry) error {
...
func (m *ChassisVPX) validatePeakFrequencySpectrum2(formats strfmt.Registry) error {
...
func (m *ChassisVPX) validatePeakOverloadSpectrum1(formats strfmt.Registry) error {
...
func (m *ChassisVPX) validatePeakOverloadSpectrum2(formats strfmt.Registry) error {
...
func (m *ChassisVPX) validatePowerHandlingCapabilityPerBoard(formats strfmt.Registry) error {
...
func (m *ChassisVPX) validateShockResponseSpectrum(formats strfmt.Registry) error {
...
func (m *ChassisVPX) validateSize(formats strfmt.Registry) error {
...
func (m *ChassisVPX) validateSlots(formats strfmt.Registry) error {
...
func (m *ChassisVPX) validateTemperaturePerBoard(formats strfmt.Registry) error {
...
func (m *ChassisVPX) validateWeight(formats strfmt.Registry) error {
...
func (m *ChassisVPX) validateWidth(formats strfmt.Registry) error {
...
// ContextValidate validates this chassis v p x based on context it is used
func (m *ChassisVPX) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *ChassisVPX) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ChassisVPX) UnmarshalBinary(b []byte) error {
	var res ChassisVPX
