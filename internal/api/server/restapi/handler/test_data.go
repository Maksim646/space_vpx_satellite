...
func (h *Handler) LoadTestDataHandler(req api.LoadTestDataParams, principal *definition.Principal) middleware.Responder {
	...
	boardComputeringModule := model.BoardComputingModule{
		Name:                    sql.NullString{String: "SXC-MB-04-ADC 1", Valid: true},
		...
		MaxSupplyVoltage:        sql.NullFloat64{Float64: 14, Valid: true},
		MinSupplyVoltage:        sql.NullFloat64{Float64: 8, Valid: true},
		PowerConsumption:        sql.NullFloat64{Float64: 1.4, Valid: true},
		DataBus:                 sql.NullString{String: "CAN", Valid: true},
	...
	powerSystem := model.CubeSatPowerSystem{
		...
		MinSystemBusVoltageOutputChannels: sql.NullFloat64{Float64: 6, Valid: true},
		MaxSystemBusVoltageOutputChannels: sql.NullFloat64{Float64: 8.4, Valid: true},
		...
		DataInterface:                     sql.NullString{String: "CAN", Valid: true},
		MaxOperatingTemperature:           sql.NullFloat64{Float64: 85, Valid: true},
		MinOperatingTemperature:           sql.NullFloat64{Float64: -40, Valid: true},
		MechanicalVibration:               sql.NullInt64{Int64: 12, Valid: true},
		MechanicalShock:                   sql.NullInt64{Int64: 50, Valid: true},
	...
	cubeSatVHFTransceiver := model.VHFTransceiver{
		...
		Interface:               sql.NullString{String: "CAN", Valid: true},
