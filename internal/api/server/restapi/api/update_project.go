...
func (fn UpdateProjectHandlerFunc) Handle(params UpdateProjectParams, principal *models.Principal) middleware.Responder {
...
/*
	UpdateProject swagger:route PATCH /project/{id} Project updateProject
