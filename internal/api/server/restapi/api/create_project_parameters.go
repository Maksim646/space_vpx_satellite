...
func (o *CreateProjectParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.CreateProjectBody
		if err := route.Consumer.Consume(r.Body, &body); err != nil {
			if err == io.EOF {
				res = append(res, errors.Required("createProject", "body", ""))
			} else {
				res = append(res, errors.NewParseError("createProject", "body", "", err))
			}
		} else {
