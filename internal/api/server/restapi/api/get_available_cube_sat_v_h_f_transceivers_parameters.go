...
// GetAvailableCubeSatVHFTransceiversParams contains all the bound params for the get available cube sat v h f transceivers operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetAvailableCubeSatVHFTransceivers
...
//
// To ensure default values, the struct must have been initialized with NewGetAvailableCubeSatVHFTransceiversParams() beforehand.
func (o *GetAvailableCubeSatVHFTransceiversParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetAvailableCubeSatVHFTransceiversParams) bindFilterCubeSatVHFTransceiverByMaxFrequency(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetAvailableCubeSatVHFTransceiversParams) bindFilterCubeSatVHFTransceiverByMinFrequency(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAvailableCubeSatVHFTransceiversParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetAvailableCubeSatVHFTransceiversParams) validateLimit(formats strfmt.Registry) error {
...
func (o *GetAvailableCubeSatVHFTransceiversParams) bindOffset(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetAvailableCubeSatVHFTransceiversParams) validateOffset(formats strfmt.Registry) error {
...
func (o *GetAvailableCubeSatVHFTransceiversParams) bindSortField(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAvailableCubeSatVHFTransceiversParams) validateSortField(formats strfmt.Registry) error {
