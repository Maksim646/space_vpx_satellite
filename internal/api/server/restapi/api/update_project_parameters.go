...
func (o *UpdateProjectParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.UpdateProjectBody
		if err := route.Consumer.Consume(r.Body, &body); err != nil {
			if err == io.EOF {
				res = append(res, errors.Required("updateProjectBody", "body", ""))
			} else {
				res = append(res, errors.NewParseError("updateProjectBody", "body", "", err))
			}
		} else {
